...
-- All the local something are lua libraries
...
globalkeys = gears.table.join(
    ...
    -- Power Prompt
    awful.key({ modkey },            "p",     function () awful.spawn("$HOME/Applicazioni/rofi/rofi-power-menu.sh") end,
              {description = "powermenu", group = "launcher"}),
    
    -- Wifi Prompt
    awful.key({ modkey },            "w",     function () awful.spawn("$HOME/Applicazioni/rofi/rofi-wifi-menu.sh") end,
              {description = "wifi menu", group = "launcher"}),
    
    -- Bluetooth Prompt
    awful.key({ modkey },            "b",     function () awful.spawn("$HOME/Applicazioni/rofi/rofi-bluetooth") end,
    {description = "bluetooth menu", group = "launcher"}),
    
    -- Music Stream Prompt
    awful.key({ modkey },            "a",     function () awful.spawn("$HOME/Applicazioni/rofi/rofi-beats-linux") end,
              {description = "radio menu", group = "launcher"})
...
awful.rules.rules = {
    ...
    { rule_any = {
        ...
        role = {
          ...
          "GtkFileChooserDialog", -- Open file dialogue box
        }
...
-- network-manager-applet, connection manager
--awful.spawn.with_shell("nm-applet")

-- Nitrogen, wallpaper chooser
--awful.spawn.with_shell("nitrogen --restore")

-- feh, wallpaper chooser
-- restores the precedently chosen wallpaper with feh --bg-
