...
globalkeys = gears.table.join(
    ...
    -- Power Prompt
    awful.key({ modkey },            "p",     function () awful.spawn("~/Applicazioni/rofi/rofi-power-menu.sh") end,
              {description = "powermenu", group = "launcher"}),
    
    -- Wifi Prompt
    awful.key({ modkey },            "w",     function () awful.spawn("~/Applicazioni/rofi/rofi-wifi-menu.sh") end,
              {description = "wifi menu", group = "launcher"}),
    
    -- Bluetooth Prompt
    awful.key({ modkey },            "b",     function () awful.spawn("~/Applicazioni/rofi/rofi-bluetooth") end,
    {description = "bluetooth menu", group = "launcher"}),
    
    -- Music Stream Prompt
    awful.key({ modkey },            "a",     function () awful.spawn("~/Applicazioni/rofi/rofi-beats-linux") end,
