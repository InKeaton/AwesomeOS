...
globalkeys = gears.table.join(
    ...
    -- Bluetooth Prompt
    awful.key({ modkey },            "b",     function () awful.spawn("/home/inkeaton/Applicazioni/rofi/rofi-bluetooth") end,
...
-- Polybar, taskbar
awful.spawn.with_shell("/home/inkeaton/.config/polybar/launch.sh")
